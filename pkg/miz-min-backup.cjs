...
if (variable === 'laravel') { 
    ...
    textFilePath = path.join(__dirname, 'classes.txt'); 
    cssFilePath = path.join(__dirname, 'public', 'assets', 'document' , 'css', 'miz-clean.css'); 
    outputFilePath = path.join(__dirname, 'public', 'assets', 'document' , 'css', 'miz.min.css'); 
    fontFaceFilePath = path.join(__dirname, 'public', 'assets', 'document' , 'css', 'font-faces.css'); 
    resetSassFile = path.join(__dirname, 'resources', 'sass', 'document' , 'miz' , 'sass' , 'config', '_reset.scss'); 
} 
else if (variable === 'laravel-landing') { 
    textFilePath = path.join(__dirname, 'classes.txt'); 
    cssFilePath = path.join(__dirname, 'public', 'assets', 'landing' , 'css', 'miz-clean.css'); 
    outputFilePath = path.join(__dirname, 'public', 'assets', 'landing' , 'css', 'miz.min.css'); 
    fontFaceFilePath = path.join(__dirname, 'public', 'assets', 'landing' , 'css', 'font-faces.css'); 
    resetSassFile = path.join(__dirname, 'resources', 'sass', 'landing' , 'miz' , 'sass' , 'config', '_reset.scss'); 
} 
